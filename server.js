...
(function() {
  var PORT, app, basedir, config, configFilename, createIndex, ejs, err, escapeTags, express, findTitleFromLex, formatDate, formatPage, fs, listEntries, listMonths, listYears, loadConfig, logMessage, marked, monthNames, obfuscateEmail, pageTemplate, pageTemplateFilename, path, recentInfo, reindexCheckFilename, respondWithNotFound, respondWithServerError;
